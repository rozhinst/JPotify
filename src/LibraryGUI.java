...
public class LibraryGUI extends JPanel{
    ...
    public LibraryGUI(){
       ...
       this.setBackground(new Color(66,28,82));
        ...
        song.setBackground(new Color(66,28,82));
        song.setForeground(Color.WHITE);
        album.setBackground(new Color(66,28,82));
        ...
        addToLibrary.setBackground(new Color(66,28,82));
